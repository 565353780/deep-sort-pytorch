...
def draw_bboxes(img, bbox, identities=None, confidences=None, offset=(0, 0), SHOW_YOLOv3_FLAGS=False):
    for i,box in enumerate(bbox):
        ...
        label = None
        if SHOW_YOLOv3_FLAGS:
            label = '{}{}'.format("", COCO_NAMES[id]) + ' , {:.3f}'.format(conf)
        else:
            label = '{}{}'.format("", id)
